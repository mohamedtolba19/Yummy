...
export default function AreaMeals() {
   ...
   let {getAreaMeals ,areaMeals} = useContext(mealsContext)

   useEffect(()=>{
    getAreaMeals(params.area)
   },[])
  ...
  {areaMeals?<div className='row justify-content-center'>
    {areaMeals.map((meal , i)=><div key={meal.idMeal} className='col-sm-6 col-md-4 col-lg-3 col-xl-3 '>
